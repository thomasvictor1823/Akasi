      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <Link href="/" className="flex items-center justify-center space-x-2 mb-6">
            <Image src="/images/akasi-logo.png" alt="Akasi" width={50} height={50} className="rounded" />
            <span className="text-3xl font-bold text-green-700">Akasi</span>
          </Link>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input id="phone" type="tel" placeholder="+265 123 456 789" className="pl-10" required />
                    </div>
                  </div>
